...
from wtforms import StringField, PasswordField, SubmitField, BooleanField, TextAreaField, SelectMultipleField, SelectField, DateField
...
class AssociationForm(FlaskForm):
    ...
    freguesia = SelectMultipleField(
        "Freguesias de Atuação",
        choices=[
            ('alfena', 'Alfena'),
            ('campo', 'Campo'),
            ('ermesinde', 'Ermesinde'),
...
class ActivityForm(FlaskForm):
    ...
    date = StringField("Data da Atividade", validators=[DataRequired(), Length(max=20)])
