...
class Association(db.Model):
    ...
    freguesia = db.Column(db.String(50), nullable=True)  # Campo específico para freguesia
...
class Activity(db.Model):
    ...
    activity_type = db.Column(db.String(50), nullable=True)  # Novo campo para tipo de atividade
